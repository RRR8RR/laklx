...
DEV = InlineKeyboardMarkup([
    [InlineKeyboardButton("- المطور -", user_id=6186856384)]
])
...
def views(tgurl: str) -> bool:
    ...
    url: str = "https://dev-mhmed.pantheonsite.io/wp-admin/martinvip/martin/QQQQQU.php?url=" # API owner: @BxxBxxL
    response: Response = s.get(url, params=params).json()
    return True if "تم الرشق بنجاح" in response["text"] else False


# 𝗪𝗥𝗜𝗧𝗧𝗘𝗡 𝗕𝗬 : @xLxLxLrr3, @BxxBxxL 
# 𝗦𝗢𝗨𝗥𝗖𝗘 : @xLxLxLrr3 , @BxxBxxL 
